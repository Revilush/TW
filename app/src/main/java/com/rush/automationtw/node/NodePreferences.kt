...
class NodePreferences(context: Context) {
    ...
    var planDueDate: String
        ...
        set(value) = prefs.edit().putString(KEY_PLAN_DUE_DATE, value.trim()).apply()

    companion object {
        private const val PREFS_NAME = "node_prefs"
        private const val KEY_SERVER_URL = "server_url"
        private const val KEY_PHONE_NUMBER = "phone_number"
        private const val KEY_PLAN_DUE_DATE = "plan_due_date"

        private const val DEFAULT_SERVER_URL = "ws://10.0.2.2:3000/ws"
